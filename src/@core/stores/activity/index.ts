    ...
    async fetchActivityReport(id: string) {
      ...
      data.value.data.assignment_details?.forEach((report: any) => {
        return reports = {
          ...
          customer: report.customer,
          products: report.products ?? [],
          reason_qty_drop_ids: report.reason_qty_drop_id,
          activity_purpose_ids: report.activity_purpose_id,
          reason_qty_drops: report.reason_qty_drop,
          activity_purposes: report.activity_purpose,
          non_active_product: report.non_active_product,
