...
const loadAll = async () => {
  ...
  await statStore.fetchMoMSummary(activityStore.report.customer.CardCode)
  await customerStore.fetchCustomerById(activityStore.report.customer.CardCode)
...
watch(missingItems, (newValue) => {
  ...
  const d = JSON.parse(missingItem)
        ...
        <VRow>
          ...
          <VRow>
            ...
            <VCol cols="12" lg="6" md="6" sm="12">
              ...
              <VBtn icon color="error" @click="handleRemoveCompetitor" v-else>
