...
declare module 'vue' {
  export interface GlobalComponents {
    AddableAutoComplete: typeof import('./src/@core/components/AddableAutoComplete.vue')['default']
    ...
    CueencyInput: typeof import('./src/@core/components/CueencyInput.vue')['default']
